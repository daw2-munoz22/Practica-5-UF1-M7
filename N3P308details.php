<head>
    ...
    <table cellpadding="2" cellspacing="2"
        ...
        <tr class="fila">
        <th style="width: 7em;"><a href="N3P308details.php?movie_id=$a&columna=review_date&orden=$c">Date</a></th>
        <th style="width: 10em;"><a href="N3P308details.php?movie_id=$a&columna=review_name&orden=$c">Reviewer</a></th>
        <th><a href="N3P308details.php?movie_id=$a&columna=review_comment&orden=$c">Comments</a></th>
        <th style="width: 5em;"><a href="N3P308details.php?movie_id=$a&columna=review_rating&orden=$c">Rating</a></th>
        </tr>
    ENDHTML;
    $media_estrellas = 0;
    $lineas = 0;
...
echo <<<ENDHTML
    ...
    <form action="N3P308details.php?movie_id=$a" method="post">
    <table>
    ...
    $rating = generate_ratings($row['review_rating']);
        ...
        $query = <<<ENDSQL
            INSERT INTO reviews
                ...
                review_rating)
            VALUES
                ("$review_movie_id","$date","$name","$comment","$rating")
            ENDSQL;
